...
import static main.java.com.app.mntr.Constants.Messages.WRONG_TOTAL_VALUE;
...
public final class PageResponse implements ExtJsonable {
    ...
    public final static class Builder {
        ...
        public Builder(final JsonObject jsonObject) {
            ...
            final long page = Configurable.ConfigBuilder.getLong(prototype, "page");
            if (page >= 0) {
                this.page = (int) page;
            } else {
                throw new IllegalArgumentException(WRONG_PAGE_VALUE);
            }
            final long total = Configurable.ConfigBuilder.getLong(prototype, "total");
            if (total >= 0) {
