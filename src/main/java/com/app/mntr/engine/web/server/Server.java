...
import static main.java.com.app.mntr.engine.web.server.Server.Settings.ALIAS;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.ALIAS_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.API_PATH;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.API_PATH_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.BACKLOG;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.BACKLOG_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.CONFIG_NAME;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.HOSTNAME;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.HOSTNAME_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.KEY_PASSWORD;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.KEY_PASSWORD_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.KEY_STORE_FILE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.KEY_STORE_FILE_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.PORT;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.PORT_VALUE;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.STORE_PASSWORD;
import static main.java.com.app.mntr.engine.web.server.Server.Settings.STORE_PASSWORD_VALUE;
...
public final class Server implements WebServer {
    ...
    public Server(final Config config, final ConfigService configService) throws Exception {
        ...
        final Config serverConfig = Validator.of(config).
                validate(c -> CONFIG_NAME.equals(c.getName()), Constants.Messages.WRONG_CONFIG_NAME).
                validate(c -> c.getProperty(KEY_STORE_FILE).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED, KEY_STORE_FILE)).
                validate(c -> c.getProperty(ALIAS).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED, ALIAS)).
                validate(c -> c.getProperty(STORE_PASSWORD).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED, STORE_PASSWORD)).
                validate(c -> c.getProperty(KEY_PASSWORD).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED, KEY_PASSWORD)).
                get();
        // Get the hostname
        ...
        final String acceptConfigEndpoint = serverConfig.getProperty(Constants.Endpoints.ACCEPT_CONFIG).
                map(Property::getValue).
