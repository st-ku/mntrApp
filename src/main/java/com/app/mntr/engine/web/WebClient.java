    ...
    public final static class Builder {
        ...
        public Builder(final Config config) {
            ...
            this.config = Validator.of(config).
                    ...
                    validate(c -> c.getProperty(METHOD).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED, METHOD)).
                    validate(c -> c.getProperty(Settings.URL).isPresent(), String.format(Constants.Messages.PARAM_NOT_PRESENTED,
                            Settings.URL)).get();
        }
